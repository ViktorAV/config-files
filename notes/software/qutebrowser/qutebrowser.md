# Qutebrowser
Браузер базированный на Firefox, с управлением vim-like.

## Конфиг
`~/.config/qutebrowser/config.py`
__:config-source__
  Перезагружает конфиг в браузере.
...
# Интервал сохранения config/cookies/etc
c.auto_save.interval = 15000
# Восстанавливать вкладки, после запуска браузера (:wq)
c.auto_save.session = False
# webengine, webkit (не рекомендуется)
c.backend = 'webengine'
c.bindings.key_mappings = {'<Ctrl-[>': '<Escape>', '<Ctrl-6>': '<Ctrl-^>', '<Ctrl-M>': '<Return>', '<Ctrl-J>': '<Return>', '<Ctrl-I>': '<Tab>', '<Shift-Return>': '<Return>', '<Enter>': '<Return>', '<Shift-Enter>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>'}
# major, minor, patch, never - логи обновления браузера
...
c.colors.contextmenu.disabled.bg = 'green'
c.colors.contextmenu.disabled.fg = None
c.colors.contextmenu.menu.bg = 'black'
c.colors.contextmenu.menu.fg = 'orange'
...
c.colors.hints.bg = '#282828'
c.colors.hints.fg = '#ebdbb2'
c.colors.hints.match.fg = '#b16286'
...
c.completion.favorite_paths = [] # :open ...
c.completion.height = '65%'
c.completion.min_chars = 1 # минимально для обновления
c.completion.open_categories = ['searchengines', 'quickmarks', 'bookmarks', 'history', 'filesystem']
c.completion.quick = True
c.completion.scrollbar.padding = 0
c.completion.scrollbar.width = 0
c.completion.shrink = False # меньший размер если нет скорл баров
c.completion.timestamp_format = '%Y-%m-%d %H:%M'
c.completion.use_best_match = False
c.completion.web_history.exclude = [] # не показывать в истории
...
c.content.blocking.enabled = True # ad/host blocker
...
c.content.cache.size = None # HTTP network cache (in bytes)
# c.content.canvas_reading = True
c.content.cookies.accept = 'all' # all, no-3rdparty, no-unknown-3rdparty, never
c.content.cookies.store = True
c.content.default_encoding = 'iso-8859-1' # iso-8859-1, utf-8, etc
c.content.desktop_capture = 'ask' # true, false, ask - share screen content for sites
...
c.content.notifications.enabled = 'ask' # true, false, ask
# c.content.notifications.presenter = 'auto'
# c.content.notifications.show_origin = True
c.content.pdfjs = False # отображать PDF файлы 
# c.content.persistent_storage = 'ask'
c.content.plugins = False
# c.content.prefers_reduced_motion = False
# c.content.print_element_backgrounds = True
c.content.private_browsing = False # приватный режим без сохранения посещений
c.content.proxy = 'system' # system, none, socks://... , http://...
# c.content.proxy_dns_requests = True
# c.content.register_protocol_handler = 'ask'
c.content.site_specific_quirks.enabled = True
# ua-whatsapp ua-google ua-slack ua-googledocs js-whatsapp-web js-discord misc-krunker
# js-string-replaceall js-globalthis js-object-fromentries misc-mathml-darkmode
c.content.site_specific_quirks.skip = ['js-string-replaceall']
c.content.tls.certificate_errors = 'ask' # ask, ask-block-thirdparty, block, load-insecurely
# c.content.unknown_url_scheme_policy = 'allow-from-user-interaction'
c.content.user_stylesheets = [] # File
...
c.downloads.open_dispatcher = None # program to open downloads
c.downloads.position = 'top' # top, bottom
c.downloads.prevent_mixed_content = True # abort insecure downloads
c.downloads.remove_finished = -1 # wait before remove finished downloads

c.editor.command = ['gvim', '-f', '{file}', '-c', 'normal {line}G{column0}l']
c.editor.encoding = 'utf-8'
c.editor.remove_file = True # удалить временный файл после закрытия редактора

c.fileselect.folder.command = ['xterm', '-e', 'ranger', '--choosedir={}']
c.fileselect.handler = 'default' # default, external
...
c.hints.radius = 3
c.hints.scatter = True # true=Vimium or dwb
...
c.history_gap_interval = 30 # minutes
...
c.input.mode_override = None # normal, insert, passthrough
...
c.logging.level.console = 'info' # vdebug, debug, info, warning, error, critical
c.logging.level.ram = 'debug' # vdebug, debug, info, warning, error, critical
c.messages.timeout = 3000

c.new_instance_open_target = 'tab' # tab, tab-bg, tab-silent, tab-bg-silent, window, private-window
c.new_instance_open_target_window = 'last-focused' # first-opened, last-opened/focused/visible
c.prompt.filebrowser = True # in downloads
c.prompt.radius = 8
...
c.statusbar.position = 'bottom' # top, bottom
c.statusbar.show = 'never' # always, never, in-mode (other than normal)
# url, scroll, scroll_raw, history, tabs, keypress, progress, text:foo
...
c.tabs.max_width = -1
c.tabs.min_width = -1
c.tabs.mode_on_change = 'normal' # persist, restore, normal
...
c.url.auto_search = 'naive' # naive, dns, never, schemeless
c.url.default_page = 'https://google.com/'
